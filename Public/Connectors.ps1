...
function New-SC365Connectors
{
    ...
    process
    {
            ...
            if($createInbound)
            {
                ...
                if ($routing -eq 'parallel') {$param.SenderIPAddresses = $SEPPmailIPv4Range}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUtfhsYqVU41+NTGvTg+n5by8w
# JDuggglAMIIEmTCCA4GgAwIBAgIQcaC3NpXdsa/COyuaGO5UyzANBgkqhkiG9w0B
...
# MRYEFOnP1Bws+lwvoP6EmzXbL3QuhvGmMA0GCSqGSIb3DQEBAQUABIIBAJ4vKMpx
# I1lkn4crNTMl1Ji3/B0cB3ArAzi6JIc4pPPa74O2C7XmTGLrj+KuB3+2L94L/2Ml
# M1irArPsvjXw+ENXTl4M/mJ46nBRDcFIG2CIBJ2/U0cf96RRzwAadkqbOmvHyv2d
# tKLor1fhJ7H7doowKtM5Pp+3+hvEYvfW4as38RWfY4ntzrETa+2KmgJWrCfWTCBj
# vxlb96fxSgP6JC2QAUpPPu0Y9U1JxeHsicl5Wk5Dcx2rrzj5yo5PvZi2Mnx1gPy+
# EW4ist95vfvtqHcezFP7O1sW6ohzrRsCndOONtMgXKBW8y+T0bFQoicgvFa3P9lI
# oJDGfQymGAJmZIQ=
