...
function Get-SC365DeploymentInfo {
    ...
    process {
        ...
        #region Query SEPPmail routing-Hosts DNS records
        ...
        Add-Member -InputObject $DeplyoymentInfo NoteProperty DeployMentStatus -Value $DeploymentStatus
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCPMY+G+6BH6CBj
# /JJ5cEAxH/0d0ym1Ue+wKCx2oFnvv6CCCUAwggSZMIIDgaADAgECAhBxoLc2ld2x
...
# BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAGELbTxAaPdGvhXK5Yq6M+6QQV
# wHme6xGSS7vt2rPjkDANBgkqhkiG9w0BAQEFAASCAQAMKJka9F1WWJVH5DWtqyk7
# Cl8pzbDJDQzBH3IR88Uom0RjulYXMOylcr4UaUkEN9lNSSI9C1EPaRCdUvacgIU+
# 4S+1rwigVqYHsfA2qn/P9TYrQX7UsQUH35SWFQRGz/yBwdBRC4OlFuL9/IP5OGSs
# 3dsAW3rS2FzH95uINRKJV0ZVYdtb6Ekj7CriYpg7MwwgteEqCITDN/foj9efQleV
# BCKooHbQ/nvgqNPUgB+iMFzLXJQKK8fSwcPyIS5E0H9U/W4qzY5J91341Am4/E55
# RpWuxk3i5v2f1Q5nZEltrPtFu7jDLOnKX0GIkg0ZsbbfwCUV79zzC6eYjIih/0kW
